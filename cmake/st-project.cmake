...
# BASED ON c:\Users\ho\Desktop\Ust\ELEC\3300\ELEC3300_Project\Code
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mcpu=cortex-m3>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32F103VETX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32F103VETX_FLASH.ld>"
)
